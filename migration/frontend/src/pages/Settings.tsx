...
/** Searchable list of expense categories with add + delete. */
function CategoryPanel() {
  ...
  return (
    <section className="settings-card cat-card">
      ...
      <p className="settings-empty" style={{ marginBottom: 10 }}>
        Search to find a category fast, then tap its ✕ to remove it.
      </p>
      <form className="inline-form" onSubmit={submit}>
        <input
